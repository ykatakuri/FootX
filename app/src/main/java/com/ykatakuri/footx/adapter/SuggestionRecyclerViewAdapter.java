...
public class SuggestionRecyclerViewAdapter extends RecyclerView.Adapter<SuggestionRecyclerViewAdapter.ViewHolder> {
    ...
    public SuggestionRecyclerViewAdapter(ArrayList<Events> eventsArrayList, Context context, EventClickInterface eventClickInterface) {
    ...
    @Override
    public void onBindViewHolder(@NonNull SuggestionRecyclerViewAdapter.ViewHolder holder, @SuppressLint("RecyclerView") int position) {
